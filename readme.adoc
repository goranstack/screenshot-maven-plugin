// Badges
image:https://github.com/goranstack/screenshot-maven-plugin/actions/workflows/ci.yml/badge.svg["Build Status", link="https://github.com/goranstack/screenshot-maven-plugin/actions/workflows/ci.yml"]
